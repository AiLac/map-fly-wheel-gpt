...
public final class Main {
    ...
    private static JsonNode help() {
        return Data.object().put("schema_version", 1).put("usage", "java -jar docs/business-flow/tools/target/business-flow-tools.jar [--project ROOT] [run] (--class FQCN [--url URL ...] | --url URL ... | --all | --resume RUN_ID)")
            .put("commands", "scan, mappings discover|resolve, task, memory, evidence, validate, publish")
            .put("guide", "docs/business-flow/README.md");
    }
}
