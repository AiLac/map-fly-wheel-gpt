...
public final class Data {
    // Workspace-relative roots. Keep distributable tooling separate from project-owned data.
    public static final String TOOLKIT_ROOT = "docs/super-business-flow-tookit";
    public static final String DATA_ROOT = "docs/super-business-flow";
    public static final String RUN_ROOT = ".temp/run/super-business-flow";
