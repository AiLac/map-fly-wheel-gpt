...
class PublicationServiceTest {
    ...
    @Test void rpcPublicationChecksCallerAndPreservesEffectiveMappingRevision() throws Exception {
        ...
        Path mapping=project.resolve("docs/super-business-flow/mappings/effective/test.yaml");Data.write(mapping,effective);String hash=Data.fingerprint(mapping);
        ...
        edge.put("kind","rpc").put("binding_id",binding.path("id").asText());edge.set("mapping_ref",Data.object().put("path","docs/super-business-flow/mappings/effective/test.yaml").put("sha256",hash));
        assertThrows(IllegalArgumentException.class,()->PublicationService.validateGraph(project,graph));
