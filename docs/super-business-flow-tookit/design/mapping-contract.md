...
java -jar docs/super-business-flow-tookit/tools/target/business-flow-tools.jar mappings discover --facts docs/super-business-flow/inventory/facts.json --rules docs/super-business-flow/frameworks/ts-rpc/rules.yaml --services docs/super-business-flow/project/services.yaml --out docs/super-business-flow/mappings/generated/ts-rpc.yaml
java -jar docs/super-business-flow-tookit/tools/target/business-flow-tools.jar mappings resolve --generated docs/super-business-flow/mappings/generated/ts-rpc.yaml --endpoints docs/super-business-flow/mappings/endpoints/manual.yaml --overrides docs/super-business-flow/mappings/overrides/ts-rpc.yaml --out docs/super-business-flow/mappings/effective/ts-rpc.yaml
```
...
evidence:
  - id: ev-framework
    path: docs/super-business-flow/frameworks/ts-rpc/input.md
...
evidence:
  - id: ev-services
    path: docs/super-business-flow/project/service-registration.md
    sha256: "<64 位真实 SHA256>"
```
...
evidence:
  - id: ev-reviewed-pair
    path: docs/super-business-flow/evidence/ts-reviewed-pair.md
    sha256: "<64 位真实 SHA256>"
```
